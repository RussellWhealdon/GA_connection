...
# Google Analytics service account JSON path
service_account_path = "path_to_your_service_account.json"

# Initialize GA Client
client = BetaAnalyticsDataClient.from_service_account_file(service_account_path)

# Your Google Analytics property ID (find it in your GA dashboard)
